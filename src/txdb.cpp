...
CZerocoinDB::CZerocoinDB(size_t nCacheSize, bool fMemory, bool fWipe) : CLevelDBWrapper(GetDataDir() / "accumulators", nCacheSize, fMemory, fWipe)
{
}
