                                                  ...
                                                  walletModel(0)
{
    ...
    ui->tableWidgetMasternodes->setColumnWidth(5, columnSupernodeWidth);
...
void MasternodeListAll::updateNodeList()
{
    ...
    BOOST_FOREACH (CMasternode& mn, vMasternodes) {
        ...
        QTableWidgetItem* supernodeItem = new QTableWidgetItem(QString::fromStdString(mn.getSupernodeStatusString()));
        ...
        ui->tableWidgetMasternodes->setItem(0, 5, supernodeItem);
