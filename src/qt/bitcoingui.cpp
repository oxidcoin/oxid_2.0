...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    overviewAction = new QAction(QIcon(":/icons/button_dashboard"), tr("&Overview"), this);
    sendCoinsAction = new QAction(QIcon(":/icons/button_send"), tr("&Send"), this);
    receiveCoinsAction = new QAction(QIcon(":/icons/button_receive"), tr("&Receive"), this);
    ...
    if (settings.value("fShowMasternodesTab").toBool()) {
        masternodeAction = new QAction(QIcon(":/icons/button_masternodes"), tr("&Masternodes"), this);
        masternodeAction->setStatusTip(tr("Show masternodes"));
        masternodeAction->setToolTip(masternodeAction->statusTip());
        masternodeAction->setCheckable(true);

        masternodeAllAction = new QAction(QIcon(":/icons/button_network"), tr("&Masternode Network"), this);
        masternodeAllAction->setStatusTip(tr("Show all nodes in masternode network"));
...
void BitcoinGUI::createToolBars()
{
    if (walletFrame) {
        ...
        header->setMinimumSize(225, 225);
        header->setMaximumSize(225, 225);
        ...
        */
        ...
        foreach(QAction *action, toolbar->actions()) {
    		toolbar->widgetForAction(action)->setFixedWidth(225);
    	}
    }
}
