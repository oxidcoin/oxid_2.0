                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Stake Reward"), TransactionFilterProxy::TYPE(TransactionRecord::StakeMint));
    typeWidget->addItem(tr("Masternode Reward"), TransactionFilterProxy::TYPE(TransactionRecord::MNReward));
    typeWidget->addItem(tr("Supernode Reward"), TransactionFilterProxy::TYPE(TransactionRecord::SNReward));
    typeWidget->addItem(tr("Received Oxid from zOXID"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zOXID"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zOXID));
