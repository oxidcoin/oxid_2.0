...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Oxid oxid-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  oxid-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded oxid transaction") + "\n" +
                               "  oxid-tx [options] -create [commands]   " + _("Create hex-encoded oxid transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded oxid transaction
